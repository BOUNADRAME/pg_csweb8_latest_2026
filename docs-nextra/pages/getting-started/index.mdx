...
| **Documentation** | Dispersée et difficile d'accès | Unifiée et accessible (255+ pages) |
...
CSWeb Community Platform s'inspire du travail de la communauté CSPro Users ([docker-csweb](https://github.com/csprousers/docker-csweb)) qui a simplifié le déploiement Docker de CSWeb. Nous avons étendu cette base pour répondre aux besoins de production des instituts statistiques.
...
- **GitHub Issues** : [Poser une question](https://github.com/BOUNADRAME/csweb-community/issues)

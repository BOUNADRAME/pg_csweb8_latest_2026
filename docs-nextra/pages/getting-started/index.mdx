...
<Callout type="success">
  CSWeb Community est 100% compatible avec CSWeb vanilla. Vous pouvez migrer vos données existantes sans perte.
</Callout>
...
<Callout type="info">
  Cette architecture permet de séparer les données métier (breakout) de la configuration (metadata), idéal pour la production.
</Callout>
...
<Callout type="warning">
  Le breakout global peut prendre des heures sur des bases volumineuses. Le breakout sélectif permet de cibler uniquement les dictionnaires nécessaires.
</Callout>
...
<Callout type="info">
  **Temps estimé :** 15 minutes pour installer et faire votre premier breakout.
</Callout>

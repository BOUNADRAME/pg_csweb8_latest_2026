...
Guide de sauvegarde et restauration pour CSWeb Community Platform.
...
Créer `/home/csweb/backup.sh` :

```bash
#!/bin/bash
# Backup automatisé CSWeb Community Platform
...
find $BACKUP_DIR -name "csweb_backup_*.tar.gz" -mtime +$RETENTION_DAYS -delete
...
tar -xzf csweb_backup_20260315_020000.tar.gz

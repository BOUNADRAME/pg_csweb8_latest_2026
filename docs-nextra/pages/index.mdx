...
<div className="grid md:grid-cols-2 gap-6 my-8">
  <div className="border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20 p-6 rounded-r-lg">
    <h3 className="text-lg font-bold mb-3 text-blue-700 dark:text-blue-300">🚀 Déploiement Rapide</h3>
    <div className="space-y-2 text-sm">
      <div>• Docker : Setup en 5 minutes</div>
      <div>• Installation manuelle : Support complet</div>
      <div>• Configuration automatisée</div>
    </div>
  </div>

  <div className="border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20 p-6 rounded-r-lg">
    <h3 className="text-lg font-bold mb-3 text-green-700 dark:text-green-300">⚡ Performance & Flexibilité</h3>
    <div className="space-y-2 text-sm">
...
[📖 Guide API & Webhooks](/guides/admin/webhooks)

...
<Callout type="info">
**Base officielle :** Basé sur CSWeb 8 téléchargé depuis le site officiel [csprousers.org/downloads](https://csprousers.org/downloads/)
</Callout>
...
- ✅ **Production-ready** : Validé sur RGPH5 Sénégal (3.2M questionnaires)

<Callout>
**Compatibilité :** 100% compatible avec CSWeb vanilla (bidirectionnel).
</Callout>
...
| **Performance (RGPH)** | 48h pour 3.2M cas | **6h pour 3.2M cas** (8x plus rapide) |
...
- **Code source :** [GitHub - pg_csweb8_latest_2026](https://github.com/BOUNADRAME/pg_csweb8_latest_2026)
...
**Attention :** Tester d'abord migration sur environnement de développement.
</Callout>
...
<Callout type="error">
**Attention :** `-v` supprime **toutes les données** (volumes). Faire backup avant !
</Callout>
...
| **RGPH / Recensement** | SQL Server | Validation RGPH5 Sénégal (3.2M cas en 6h) |
...
**Documentation :** [Architecture - Flexible](/guides/architecture/flexible#migration-à-chaud)
...
- ✅ **Scalabilité** : RGPH5 Sénégal = 3.2M cas en 6h (vs 48h en global)
...
| **Performance** | Lent (locks, contention) | Rapide (parallèle, isolation) |
| **Exemple** | `cases`, `level_1` | `eval_cases`, `kairos_cases` |
| **RGPH5 (3.2M)** | ~48h | **~6h** (8x plus rapide) |
...
| Cas | Dictionnaires | Threads | Temps |
|-----|---------------|---------|-------|
| **Test** | 100 | 1 | < 1 min |
| **Dev** | 1,000 | 3 | ~5 min |
| **Petit INS** | 50,000 | 5 | ~1h |
| **RGPH5** | 3,200,000 | 10 | **6h** |

**Formule approximative :**
```
Temps (min) ≈ (Nb_cas × 0.005) / Nb_threads
```
...
**Validations :**
- ✅ **RGPH5 Sénégal** : 3.2M questionnaires (ANSD, 2025)
...
| 100,000 cas | ~2 GB |
| 1,000,000 cas | ~8 GB |
| 3,200,000 cas (RGPH5) | ~16 GB |

**Recommandations serveur :**
- < 100k cas : 4 GB RAM
- 100k-1M cas : 8 GB RAM
- > 1M cas : 16+ GB RAM
...
<Callout type="warning">
**IMPORTANT :** Changer `admin123` en production (risque sécurité).
</Callout>
...
**2. GitHub Issues :**
- [https://github.com/BOUNADRAME/pg_csweb8_latest_2026/issues](https://github.com/BOUNADRAME/pg_csweb8_latest_2026/issues)
- Créer issue avec :
...
- **6 heures** de breakout total
- **8x plus rapide** que breakout global
...
2. **GitHub Issues** : [Créer une issue](https://github.com/BOUNADRAME/pg_csweb8_latest_2026/issues/new)

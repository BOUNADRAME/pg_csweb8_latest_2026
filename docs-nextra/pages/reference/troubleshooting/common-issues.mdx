...
<Callout type="info">
**Structure :** Chaque problème inclut :
- 🔴 **Symptôme** : Message d'erreur ou comportement observé
...
SELECT username, role, enabled FROM cspro_users;
```
...
**Ne JAMAIS modifier** les fichiers migration déjà appliqués. Créer une nouvelle migration.
</Callout>

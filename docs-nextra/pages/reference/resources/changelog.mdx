# Changelog Historique des modifications de CSWeb Community Platform.
...
- **Performance** : 6h vs 48h (RGPH5 - 3.2M questionnaires)
...
## Changelog Complet Le changelog complet est disponible dans le fichier source :
...
## Format Ce changelog suit les conventions :
